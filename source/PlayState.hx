...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			gf = new Character(0, 0, 'gf', gfVersion);
		...
		dad = new Character(0, 0, 'dad', SONG.player2);
		...
		switch(type) {
			...
			case 1:
				if(!dadMap.exists(newCharacter)) {
					var newDad:Character = new Character(0, 0, 'dad', newCharacter);
			...
			case 2:
				if(gf != null && !gfMap.exists(newCharacter)) {
					var newGf:Character = new Character(0, 0, 'gf', newCharacter);
	...
	// var prevMousePos:Array<Float> = [0, 0];
	var prevMousePos:Array<Float> = [FlxG.game.mouseX, FlxG.game.mouseY];

	override public function update(elapsed:Float)
	{
		if (FlxG.game.mouseX != prevMousePos[0] || FlxG.game.mouseY != prevMousePos[1]) {
			FlxG.mouse.visible = true;
			if (mouseTimer != null)
				mouseTimer.cancel();
			mouseTimer = new FlxTimer().start(4.5,
				function(twn:FlxTimer)
				{	
					mouseTimer = null;
		...
		prevMousePos = [FlxG.game.mouseX, FlxG.game.mouseY];
		// trace('$prevMouseX, $prevMouseY');
